...
namespace PortfolioTrackerApi.Services
{
    public class EmailVerificationService : IEmailVerificationService
    {
        ...
        private readonly EmailStoreService _emailStoreService;

        public EmailVerificationService()
        {
            _emailStoreService = new EmailStoreService();
        }
        ...
        public async Task SendVerificationCode(string email)
{
    ...
    if (_emailStoreService.IsEmailVerified(email))
        ...
        public bool VerifyCode(string email, string code)
{
    ...
    if (_verificationCodes.TryGetValue(email, out var entry))
    {
        ...
        {
            _verificationCodes.TryRemove(email, out _);
            _emailStoreService.AddEmail(email); // Save verified email
            return true;
        }
    }
